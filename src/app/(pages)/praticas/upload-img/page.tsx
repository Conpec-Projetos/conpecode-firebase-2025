  ...
  */
  ...
  return (
    <main className="h-screen w-screen flex flex-col items-center justify-center gap-4 bg-gradient-to-b from-conpec-orange-faded to-conpec-orange-strong select-none">
      <InfoButton
        link="https://firebase.google.com/docs/storage/web/upload-files?hl=pt-BR&authuser=1"
      ...
      <button
        className={` ${
          file
            ? "bg-blue-500 hover:bg-blue-700 hover:shadow-xl cursor-pointer"
            : "bg-blue-300"
        }  text-white px-4 py-2 mt-2.5 rounded transition-all duration-300`}
        onClick={() => {
          uploadImage();
        }}
        disabled={!file}
